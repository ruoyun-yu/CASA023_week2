...
---
#Recflection
ICEYE adopts miniaturized SAR technology, enabling high-resolution radar imaging that previously required large satellites to be achieved using small satellites. This indicates that remote sensing technology is evolving towards higher efficiency, lower costs, and commercialization, providing services to a wider range of industries. Unlike government-launched satellites, ICEYE, as a commercial satellite provider, offers its data for purchase by various organizations, promoting data accessibility and supporting scientific research, environmental monitoring, and other needs.  
```{r , echo=FALSE, out.width='30%', fig.align='central'}
htmltools::tags$div(
  style = "text-align: center;",
  htmltools::tags$img(src = "picture/application.jpg", width = "30%")
)
```
---
#Recflection
However, the excessive commercialization of the remote sensing data market may also lead to negative consequences. For instance, data inequality remains an issue—although ICEYE has made remote sensing data more accessible, only technologically advanced countries and institutions can truly leverage it, while impoverished regions may struggle to obtain critical environmental and disaster monitoring data. Additionally, privacy and security concerns arise, as high-resolution SAR data can be used for military reconnaissance, potentially raising national security concerns or even being exploited for illegal surveillance.  

Moreover, ICEYE satellites are numerous and have short lifespans. Without an effective disposal mechanism, they could contribute to space debris, posing a threat to other satellites.


```{r , echo=FALSE, out.width='30%'}
htmltools::tags$div(
  style = "text-align: center;",
  htmltools::tags$img(src = "picture/rubbish.jpg", width = "30%")
)
